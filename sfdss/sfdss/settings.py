"""
Django settings for sfdss project.
...
SECRET_KEY = 'yzs0u#jcg*wa2khwsfg!1sg@qm5a*st@-bcvp)eav32#m@j6y1'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1','localhost','276def0f396d.ngrok.io']
...
WSGI_APPLICATION = 'sfdss.wsgi.application'
